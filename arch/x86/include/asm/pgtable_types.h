...
//DBvsCoW start
#define _PAGE_BIT_SOFTW5	52	/* Extra clear bit*/
//DBvsCoW end 
...
//DBvsCoW start
#define _PAGE_SOFTW5	(_AT(pteval_t, 1) << _PAGE_BIT_SOFTW5)
//DBvsCoW end 
...
//DBvsCoW start
#define _PAGE_KNL_ERRATUM_MASK (_PAGE_BIT_SOFTW5 | _PAGE_DIRTY | _PAGE_ACCESSED | _PAGE_SOFTW2)
//DBvsCoW end 
#else
